...
this IDbConnection cnn, string sql, dynamic param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
...
)
        {
            ...
            //IEnumerable m = param as IEnumerable;
...
#pragma warning restore 618
        ...
        /// </summary>
        private const string DataTableTypeNameKey = "FirstFrame.Dapper:TypeName";
        ...
        public partial class GridReader : IDisposable
        {
            ...
            {
                // change if the reader is null or consumed true,then result new list by nice at 2014-12-21 11:23:03
                if (reader == null || consumed) return new List<T>();
                ...
                int hash = GetColumnHash(reader);
                if (hash == 0) return new List<T>();        // add if the hash equal zero,then retrun new list by nice at 2014-12-21 11:24:44
                ...
                var r = buffered ? result.ToList() : result;

                // add if the reader is not null,then dispose. by nice at 2015-01-01 10:54:13
                if (reader != null)
                {
...
#pragma warning restore 612, 618
        ...
        public T Get<T>(string name)
        {
            ...
            if (val == DBNull.Value)
            {
                // change val is null, return a default value. by nice at 2015-02-06 13:48:48
                //if (default(T) != null)
                //{
