...
namespace Aliyun.OpenServices.OpenStorageService
{
    ...
    public class CORSRule
    {
        ...
        /// 添加一条AllowedMethod。
        /// </summary>
        /// <param name="allowedMethod"></param>
        ...
        /// 添加一条AllowedHeader。
        /// </summary>
        /// <param name="allowedHeader"></param>
        ...
        /// 添加一条ExposeHeader。
        /// </summary>
        /// <param name="exposedHeader"></param>
        ...
        /// <returns></returns>
        private static int CountOfAsterisk(IList<string> items)
        {
            var count = 0;
        ...
        private static bool InAllowedMethods(string allowedMethod)
        {
            ...
            if (tmp == "GET" || tmp == "PUT" || tmp == "DELETED" || tmp == "POST" || tmp == "HEAD")
            {
                return true;
            }
