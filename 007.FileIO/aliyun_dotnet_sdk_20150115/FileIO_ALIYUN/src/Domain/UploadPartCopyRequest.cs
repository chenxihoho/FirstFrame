...
namespace Aliyun.OpenServices.OpenStorageService
{
    ...
    public class UploadPartCopyRequest
    {
        ...
        public UploadPartCopyRequest(string targetBucket, string targetKey, string sourceBucket, string sourceKey, string uploadId)
        {
            ...
            if (string.IsNullOrEmpty(targetKey))
                throw new ArgumentException(Resources.ExceptionIfArgumentStringIsNullOrEmpty, "targetKey");
            if (string.IsNullOrEmpty(sourceBucket))
                throw new ArgumentException(Resources.ExceptionIfArgumentStringIsNullOrEmpty, "sourceBucket");
            ...
            if (!OssUtils.IsObjectKeyValid(targetKey))
                throw new ArgumentException(OssResources.ObjectKeyInvalid, "targetKey");
            if (!OssUtils.IsBucketNameValid(sourceBucket))
                throw new ArgumentException(OssResources.BucketNameInvalid, "sourceBucket");
